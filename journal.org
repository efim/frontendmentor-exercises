...
** TODO component for all comments
** TODO component for whole comment section & submit new top level ui
** TODO text wrap, when word is longer than element width
** TODO submit by ctrl + Enter
